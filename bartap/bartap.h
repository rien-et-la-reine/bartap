...
// internal driver functions, these are all static and technically all of this could just be in the .c file but this is an easier way for me to keep track of all the functions without scrolling through a bunch of code
/*!
